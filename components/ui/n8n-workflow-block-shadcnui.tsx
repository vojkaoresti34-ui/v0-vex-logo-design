...
const nodeTemplates: Omit<WorkflowNode, "id" | "position">[] = [
  {
    type: "trigger",
    title: "User Request",
    description: "Input brand name & style",
    icon: MessageSquare,
    color: "emerald",
  },
  {
    type: "action",
    title: "AI Analysis",
    description: "Extract design keywords",
    icon: Sparkles,
    color: "blue",
  },
  {
    ...
    description: "Create 4 logo variations",
    icon: Palette,
    color: "amber",
  },
  {
    ...
    description: "Vectorize final choice",
    icon: Layers,
    color: "purple",
  },
  {
    type: "action",
    title: "Export Assets",
    description: "SVG, PNG, PDF formats",
    icon: FileImage,
    color: "indigo",
  },
];
