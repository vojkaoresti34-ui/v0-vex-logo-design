  ...
  return (
    <section className="py-32 relative overflow-hidden bg-background">
      <div className="max-w-[1200px] mx-auto px-6 relative z-10" ref={containerRef}>
        ...
        >
          <div className="bg-secondary rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden border border-white/10 shadow-2xl">
            ...
            <div className="relative z-10">
              <h2 className="text-5xl md:text-7xl font-[900] text-white mb-8 tracking-tighter uppercase leading-none">
                Ready to Land Your
                <br />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <Link
                  href="#"
                  className="group bg-primary text-secondary px-12 py-6 rounded-full text-xl font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all duration-300 shadow-2xl shadow-primary/30"
                >
                  Start Free Trial
